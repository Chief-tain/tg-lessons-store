...
HELP_MESSAGE = (
    ...
    "<b>2. /english_lessons</b> - Просмотреть список доступных уроков по английскому языку.\n"
    "<b>3. /chinese_lessons</b> - Просмотреть список доступных уроков по китайскому языку.\n"
